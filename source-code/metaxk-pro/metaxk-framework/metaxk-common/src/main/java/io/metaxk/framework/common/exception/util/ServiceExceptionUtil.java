package io.metaxk.framework.common.exception.util;
 ...
 *
 * 1. 异常提示信息，写在枚举类中，例如说，io.metaxk.oceans.user.api.constants.ErrorCodeEnum 类 + ServiceExceptionConfiguration
