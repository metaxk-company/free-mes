package io.metaxk.framework.operatelog.core.aop;
...
import io.metaxk.framework.common.util.monitor.TracerUtils;
...
import io.metaxk.framework.operatelog.core.service.OperateLog;
...
import static io.metaxk.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        io.metaxk.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                io.metaxk.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         io.metaxk.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           io.metaxk.framework.operatelog.core.annotations.OperateLog operateLog,
