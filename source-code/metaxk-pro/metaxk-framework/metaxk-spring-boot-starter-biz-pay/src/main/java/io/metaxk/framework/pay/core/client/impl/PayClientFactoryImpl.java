...
import io.metaxk.framework.pay.core.client.impl.alipay.*;
import io.metaxk.framework.pay.core.client.impl.wx.WXLitePayClient;
import io.metaxk.framework.pay.core.client.impl.wx.WXNativePayClient;
...
public class PayClientFactoryImpl implements PayClientFactory {
    ...
    private <Config extends PayClientConfig> AbstractPayClient<Config> createPayClient(
        ...
        // 创建客户端
        // TODO @星空斗士 WX_LITE WX_APP 如果不添加在 项目启动的时候去初始化会报错无法启动。所以我手动加了两个，具体需要你来配
        switch (channelEnum) {
