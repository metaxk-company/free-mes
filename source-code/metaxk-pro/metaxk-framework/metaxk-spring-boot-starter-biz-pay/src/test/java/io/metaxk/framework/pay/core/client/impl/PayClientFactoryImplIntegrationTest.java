package io.metaxk.framework.pay.core.client.impl;

import cn.hutool.core.io.IoUtil;
import cn.hutool.core.util.RandomUtil;
import io.metaxk.framework.pay.core.client.PayClient;
import io.metaxk.framework.pay.core.client.dto.order.PayOrderUnifiedReqDTO;
import io.metaxk.framework.pay.core.client.impl.alipay.AlipayPayClientConfig;
import io.metaxk.framework.pay.core.client.impl.alipay.AlipayQrPayClient;
import io.metaxk.framework.pay.core.client.impl.alipay.AlipayWapPayClient;
import io.metaxk.framework.pay.core.client.impl.wx.WXPayClientConfig;
import io.metaxk.framework.pay.core.client.impl.wx.WXPubPayClient;
...
//        System.out.println(result);
    ...
    public void testCreatePayClient_WX_PUB_V3() throws FileNotFoundException {
        ...
        config.setPrivateKeyContent(IoUtil.readUtf8(new FileInputStream("/Users/metaxk/Downloads/wx_pay/apiclient_key.pem")));
        config.setPrivateCertContent(IoUtil.readUtf8(new FileInputStream("/Users/metaxk/Downloads/wx_pay/apiclient_cert.pem")));
...
//        System.out.println(result);
    ...
    public void testCreatePayClient_ALIPAY_QR() {
        ...
        // 发起支付
        PayOrderUnifiedReqDTO reqDTO = buildPayOrderUnifiedReqDTO();
        reqDTO.setNotifyUrl("http://metaxk.natapp1.cc/admin-api/pay/notify/callback/18"); // TODO @tina: 这里改成你的 natapp 回调地址
