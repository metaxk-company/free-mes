...
import io.metaxk.framework.sms.core.client.impl.debug.DebugDingTalkSmsClient;
...
public class DebugDingTalkSmsClientIntegrationTest {
    ...
    public static void init() {
        ...
        properties.setId(1L);
        properties.setSignature("万界星空科技");
...
//        SmsResult result = smsClient.send(1L, "15888888888", "4372216", templateParams);
        SmsCommonResult<SmsSendRespDTO> result = smsClient.sendSms(1L, "15888888888", "4383920", templateParams);
