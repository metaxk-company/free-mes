package io.metaxk.framework.social.core;

import cn.hutool.core.util.EnumUtil;
import cn.hutool.core.util.ReflectUtil;
import io.metaxk.framework.social.core.enums.AuthExtendSource;
import io.metaxk.framework.social.core.request.AuthWeChatMiniAppRequest;
 ...
 * @date 2021-10-31
 */
public class MetaxkAuthRequestFactory extends AuthRequestFactory {
    ...
    public MetaxkAuthRequestFactory(JustAuthProperties properties, AuthStateCache authStateCache) {
