 ...
 *      1）Spring Async：
 *          {@link io.metaxk.framework.quartz.config.MetaxkAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 MetaxkSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package io.metaxk.framework.tenant;
