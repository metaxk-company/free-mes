package io.metaxk.framework.file.core.client.s3;
...
public class S3FileClientTest {
    ...
    public void testAliyun() throws Exception {
        ...
        config.setBucket("metaxk-aoteman");
        config.setDomain(null); // 如果有自定义域名，则可以设置。http://ali-oss.metaxk.io
        // 默认北京的 endpoint
    ...
    public void testQCloud() throws Exception {
        ...
        config.setDomain(null); // 如果有自定义域名，则可以设置。http://tengxun-oss.metaxk.io
        // 默认上海的 endpoint
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setBucket("metaxk-pro");
        config.setDomain("http://test.metaxk.metaxk.io"); // 如果有自定义域名，则可以设置。http://static.metaxk.metaxk.io
        // 默认上海的 endpoint
