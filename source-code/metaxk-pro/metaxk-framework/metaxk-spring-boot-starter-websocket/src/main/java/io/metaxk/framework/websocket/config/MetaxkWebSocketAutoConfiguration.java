 ...
 */
@AutoConfiguration
// 允许使用 metaxk.websocket.enable=false 禁用websocket
@ConditionalOnProperty(prefix = "metaxk.websocket", value = "enable", matchIfMissing = true)
@EnableConfigurationProperties(WebSocketProperties.class)
public class MetaxkWebSocketAutoConfiguration {
    @Bean
