package io.metaxk.framework.websocket.core;
...
public class MetaxkWebSocketHandlerDecorator extends WebSocketHandlerDecorator {
    public MetaxkWebSocketHandlerDecorator(WebSocketHandler delegate) {
        super(delegate);
    }
