package io.metaxk.module.infra.controller.admin.codegen.vo.table;
...
public class CodegenTableBaseVO {
    ...
    @Schema(description = "表名称", required = true, example = "metaxk")
    @NotNull(message = "表名称不能为空")
    private String tableName;

    @Schema(description = "表描述", required = true, example = "万界星空科技")
    ...
    @Schema(description = "作者", required = true, example = "万界星空科技")
