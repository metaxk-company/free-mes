package io.metaxk.module.infra.controller.admin.config;
...
import io.metaxk.module.infra.controller.admin.config.vo.*;
import io.metaxk.module.infra.convert.config.ConfigConvert;
import io.metaxk.module.infra.dal.dataobject.config.ConfigDO;
import io.metaxk.module.infra.enums.ErrorCodeConstants;
import io.metaxk.module.infra.service.config.ConfigService;
...
public class ConfigController {
    ...
    @Parameter(name = "key", description = "参数键", required = true, example = "metaxk.biz.username")
