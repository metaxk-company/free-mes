...
import io.metaxk.module.member.service.auth.MemberAuthServiceImpl;
 ...
 * @author 宋天
 */
@Import({MemberUserServiceImpl.class, MetaxkRedisAutoConfiguration.class})
