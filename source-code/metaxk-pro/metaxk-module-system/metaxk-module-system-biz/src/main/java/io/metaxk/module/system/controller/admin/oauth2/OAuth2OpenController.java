...
import io.metaxk.framework.common.util.http.HttpUtils;
...
import io.metaxk.module.system.convert.oauth2.OAuth2OpenConvert;
...
import io.metaxk.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import io.metaxk.module.system.service.oauth2.OAuth2ApproveService;
import io.metaxk.module.system.service.oauth2.OAuth2ClientService;
import io.metaxk.module.system.service.oauth2.OAuth2GrantService;
...
import static io.metaxk.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static io.metaxk.framework.common.exception.util.ServiceExceptionUtil.exception0;
import static io.metaxk.framework.common.pojo.CommonResult.success;
import static io.metaxk.framework.common.util.collection.CollectionUtils.convertList;
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "https://www.metaxk.io"),
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "https://www.metaxk.io"),
