package io.metaxk.module.system.controller.admin.oauth2.vo.client;
...
public class OAuth2ClientBaseVO {
    ...
    @Schema(description = "可重定向的 URI 地址", required = true, example = "https://www.metaxk.io")
    ...
    @Schema(description = "附加信息", example = "{metaxk: true}")
