...
public class SmsChannelBaseVO {
    ...
    @Schema(description = "短信签名", required = true, example = "万界星空科技")
    ...
    @Schema(description = "短信 API 的账号", required = true, example = "metaxk")
    ...
    @Schema(description = "短信发送回调 URL", example = "http://www.metaxk.io")
