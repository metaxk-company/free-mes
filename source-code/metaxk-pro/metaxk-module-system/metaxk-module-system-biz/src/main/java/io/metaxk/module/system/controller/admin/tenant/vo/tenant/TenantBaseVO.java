...
public class TenantBaseVO {
    ...
    @Schema(description = "租户名", required = true, example = "万界星空科技")
    @NotNull(message = "租户名不能为空")
    private String name;

    @Schema(description = "联系人", required = true, example = "星空斗士")
    ...
    @Schema(description = "绑定域名", example = "https://www.metaxk.io")
