...
import io.metaxk.module.system.dal.dataobject.sms.SmsCodeDO;
import io.metaxk.module.system.dal.mysql.sms.SmsCodeMapper;
import io.metaxk.module.system.enums.sms.SmsSceneEnum;
import io.metaxk.module.system.framework.sms.SmsCodeProperties;
...
import static io.metaxk.framework.common.util.date.DateUtils.isToday;
...
public class SmsCodeServiceImpl implements SmsCodeService {
    ...
    private String createSmsCode(String mobile, Integer scene, String ip) {
        ...
        if (lastSmsCode != null) {
            ...
            // TODO 星空斗士：提升，每个 IP 每天可发送数量
            // TODO 星空斗士：提升，每个 IP 每小时可发送数量
        }
