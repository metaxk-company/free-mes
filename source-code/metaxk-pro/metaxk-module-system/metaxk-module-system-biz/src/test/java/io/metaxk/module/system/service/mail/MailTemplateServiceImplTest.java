...
import io.metaxk.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static io.metaxk.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
       ...
       // 测试 name 不匹配
       mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("万界星空科技")));
       // 测试 code 不匹配
