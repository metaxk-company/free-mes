...
import io.metaxk.module.system.dal.mysql.permission.MenuMapper;
import io.metaxk.module.system.enums.permission.MenuTypeEnum;
import io.metaxk.module.system.mq.producer.permission.MenuProducer;
...
import static io.metaxk.module.system.dal.dataobject.permission.MenuDO.ID_ROOT;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("星空斗士").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
        menuMapper.insert(cloneIgnoreId(menuDO, o -> o.setStatus(CommonStatusEnum.DISABLE.getStatus())));
        // 测试 name 不匹配
        menuMapper.insert(cloneIgnoreId(menuDO, o -> o.setName("斗士")));
        // 准备参数
        MenuListReqVO reqVO = new MenuListReqVO().setName("星空").setStatus(CommonStatusEnum.ENABLE.getStatus());
