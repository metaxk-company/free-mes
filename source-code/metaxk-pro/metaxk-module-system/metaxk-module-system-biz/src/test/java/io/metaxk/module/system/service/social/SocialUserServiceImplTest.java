package io.metaxk.module.system.service.social;
...
import io.metaxk.module.system.dal.dataobject.social.SocialUserBindDO;
import io.metaxk.module.system.dal.dataobject.social.SocialUserDO;
import io.metaxk.module.system.dal.mysql.social.SocialUserBindMapper;
import io.metaxk.module.system.dal.mysql.social.SocialUserMapper;
...
import static io.metaxk.module.system.enums.ErrorCodeConstants.SOCIAL_USER_AUTH_FAILURE;
import static io.metaxk.module.system.enums.ErrorCodeConstants.SOCIAL_USER_NOT_FOUND;
...
public class SocialUserServiceImplTest extends BaseDbAndRedisUnitTest {
    ...
    @MockBean
    private MetaxkAuthRequestFactory authRequestFactory;
    ...
    public void testGetAuthorizeUrl() {
        try (MockedStatic<AuthStateUtils> authStateUtilsMock = mockStatic(AuthStateUtils.class)) {
            ...
            when(authRequest.authorize(eq("aoteman"))).thenReturn("https://www.metaxk.io?redirect_uri=yyy");

            // 调用
            String url = socialUserService.getAuthorizeUrl(type, redirectUri);
            // 断言
            assertEquals("https://www.metaxk.io?redirect_uri=sss", url);
        }
    }
