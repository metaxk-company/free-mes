package io.metaxk.module.system.service.user;
...
import io.metaxk.module.infra.api.file.FileApi;
...
import io.metaxk.module.system.dal.mysql.dept.UserPostMapper;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("metaxk");
        ...
        assertEquals("metaxk", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("metaxk"))).thenReturn("java");
