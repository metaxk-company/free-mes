...
export const queryTableList = async (params?: Object) => {
  return await request.get({
    url: `${import.meta.env.VITE_API_URL_ADMIN}/mes/wh/rec/bill/list`,
    params
  })
}
...
// 查询
export const queryFormInfo = async (params) => {
  return await request.get({
    url: `${import.meta.env.VITE_API_URL_ADMIN}/mes/wh/rec/bill/detail`,
    params
  })
}
