...
export const getNotifyMessagePageApi = async (params: NotifyMessagePageReqVO) => {
  return await request.get({
    url: import.meta.env.VITE_API_URL_ADMIN + '/system/notify-message/page',
    params
  })
}
...
export const getNotifyMessageApi = async (id: number) => {
  return await request.get({
    url: import.meta.env.VITE_API_URL_ADMIN + '/system/notify-message/get?id=' + id
  })
}
...
export const getMyNotifyMessagePage = async (params: NotifyMessageMyPageReqVO) => {
  return await request.get({
    url: import.meta.env.VITE_API_URL_ADMIN + '/system/notify-message/my-page',
    params
  })
}
...
export const updateAllNotifyMessageRead = async () => {
  return await request.put({
    url: import.meta.env.VITE_API_URL_ADMIN + '/system/notify-message/update-all-read'
  })
}
...
export const getUnreadNotifyMessageListApi = async () => {
  return await request.get({
    url: import.meta.env.VITE_API_URL_ADMIN + '/system/notify-message/get-unread-list'
  })
}
...
export const getUnreadNotifyMessageCountApi = async () => {
  return await request.get({
    url: import.meta.env.VITE_API_URL_ADMIN + '/system/notify-message/get-unread-count'
  })
}
