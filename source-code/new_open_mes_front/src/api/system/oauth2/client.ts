...
export const getOAuth2ClientPageApi = (params: OAuth2ClientPageReqVO) => {
  return request.get({
    url: import.meta.env.VITE_API_URL_ADMIN + '/system/oauth2-client/page',
    params
  })
}
...
export const getOAuth2ClientApi = (id: number) => {
  return request.get({
    url: import.meta.env.VITE_API_URL_ADMIN + '/system/oauth2-client/get?id=' + id
  })
}
...
export const createOAuth2ClientApi = (data: OAuth2ClientVO) => {
  return request.post({
    url: import.meta.env.VITE_API_URL_ADMIN + '/system/oauth2-client/create',
    data
  })
}
...
export const updateOAuth2ClientApi = (data: OAuth2ClientVO) => {
  return request.put({
    url: import.meta.env.VITE_API_URL_ADMIN + '/system/oauth2-client/update',
    data
  })
}
...
export const deleteOAuth2ClientApi = (id: number) => {
  return request.delete({
    url: import.meta.env.VITE_API_URL_ADMIN + '/system/oauth2-client/delete?id=' + id
  })
}
