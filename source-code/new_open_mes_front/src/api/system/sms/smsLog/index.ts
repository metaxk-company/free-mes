...
export const getSmsLogPageApi = (params: SmsLogPageReqVO) => {
  return request.get({ url: import.meta.env.VITE_API_URL_ADMIN + '/system/sms-log/page', params })
}

// 导出短信日志
export const exportSmsLogApi = (params: SmsLogExportReqVO) => {
  return request.download({
    url: import.meta.env.VITE_API_URL_ADMIN + '/system/sms-log/export-excel',
    params
  })
}
