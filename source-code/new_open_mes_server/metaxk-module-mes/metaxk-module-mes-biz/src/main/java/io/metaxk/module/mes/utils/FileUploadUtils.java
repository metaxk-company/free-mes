...
import io.metaxk.module.mes.common.*;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    public static String defaultBaseDir = "/Users/alex/Downloads/其他MES/metaxk-mes/uploadPath";
     ...
     * Minio默认上传的地址
     */
    private static String bucketName = "mes";
            ...
            InvalidExtensionException
    {
        ...
        {
            String fileName = extractFilename(file);
            String pathFileName = MinioUtil.uploadFile(getBucketName(), fileName, file);
            return pathFileName;
        }
        catch (Exception e)
        {
